...
const categories=[
 {name:"Mezeler",img:"sezar.jpg",sub:"Sofraya sıcak bir başlangıç"},{name:"Omletler",img:"alfredo.jpg",sub:"Güne lezzetli bir başlangıç"},{name:"Krepler",img:"alfredo.jpg",sub:"Fırından sıcak krep çeşitleri"},{name:"Menemen",img:"tavuk.jpg",sub:"Tavadan sıcak klasikler"},{name:"Salatalar",img:"sezar.jpg",sub:"Taze ve hafif seçenekler"},{name:"Makarnalar",img:"spaghetti.jpg",sub:"Özel soslar ve reçeteler"},{name:"Tavuklar",img:"tavuk.jpg",sub:"Izgara ve özel soslar"},{name:"Et Yemekleri",img:"burger.jpg",sub:"Güçlü ve seçkin lezzetler"},{name:"Aperatifler",img:"bonfrit.jpg",sub:"Paylaşmalık ve atıştırmalık lezzetler"},{name:"Burgerler",img:"burger.jpg",sub:"Doyurucu Lobby lezzetleri"},{name:"Çorbalar",img:"corbalar.jpg",sub:"Günün sıcak çorba çeşitleri"},{name:"Kurudite",img:"kurudite.jpg",sub:"Taze sebzeler ve eşlikçiler"},{name:"Meşrubatlar",img:"mesrubatlar.jpg",sub:"Soğuk içecek ve meşrubat çeşitleri"},{name:"Sıcak İçecekler",img:"latte.jpg",sub:"Kahve ve çay çeşitleri"},{name:"Soğuk İçecekler",img:"latte.jpg",sub:"Ferahlatan seçenekler"},{name:"Bitki Çayları",img:"bitki-caylari.jpg",sub:"Doğal, aromatik ve rahatlatıcı bitki çayları"},{name:"Sıcak Kahveler",img:"sicak-kahveler.jpg",sub:"Espresso bazlı kahve çeşitleri"},{name:"Soğuk Kahveler",img:"soguk-kahveler.jpg",sub:"Buz gibi espresso bazlı kahveler"},{name:"Smoothie & Frozen",img:"smoothie-frozen.jpg",sub:"Smoothie, frozen ve milkshake çeşitleri"},{name:"Kokteyller",img:"latte.jpg",sub:"Lobby bar seçkisi"},{name:"Biralar",img:"biralar.jpg",sub:"Bira çeşitleri"},{name:"Rakılar",img:"rakılar.jpg",sub:"Rakı çeşitleri"},{name:"Votkalar",img:"votkalar.jpg",sub:"Votka çeşitleri"},{name:"Viskiler",img:"viski.jpg",sub:"Viski çeşitleri"},{name:"Şaraplar",img:"sarap.jpg",sub:"Şarap Çeşitleri"},{name:"İthal İçecekler",img:"ithal-icecekler.jpg",sub:"İthal içecek çeşitleri"},
];
...
"Blush Kadeh":630,
"Kadeh Şarap":400,
"Şişe Şarap 37.5 CL":800,
"Şişe Şarap 75 CL":1500,
"B-52":210,
"Baileys":400,
"Tek Cin":330,
"Double Cin":440,
...
P("Tavuklar","Izgara Tavuk","ızgara-tavuk.jpg","Marine edilmiş ızgara tavuk.","430 kcal","315 g (garnitür dahil)","Tavuk göğsü 200 g, zeytinyağı 10 ml, tuz 2 g, karabiber 1 g, kekik 1 g, kırmızı biber 1 g, isteğe bağlı sarımsak 3 g; soya sosu."),
...
P("Meşrubatlar","Ayran","ayran.jpg","Geleneksel soğuk ayran.","","1 Bardak","Yoğurt, Su, Tuz","Süt içerir."),
P("Meşrubatlar","Büyük Su","buyuk-su.jpg","1 L doğal kaynak suyu.","","1 Litre","Doğal Kaynak Suyu","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Cappy","cappy.jpg","Meyve suyu çeşitleri.","","330 ml","Meyve Suyu","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Churchill","churchill.jpg","Maden suyu, limon ve tuz ile hazırlanır.","","1 Bardak","Maden Suyu, Limon, Tuz","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Cola","cola.jpg","Soğuk gazlı içecek.","","330 ml","Gazlı İçecek","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Fanta","fanta.jpg","Portakal aromalı gazlı içecek.","","330 ml","Gazlı İçecek","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Sprite","sprite.jpg","Limon aromalı gazlı içecek.","","330 ml","Gazlı İçecek","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Cool Berry","cool-berry.jpg","Orman meyveli ferahlatıcı içecek.","","1 Bardak","Meyve Aroması","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Cool Lime","cool-lime.jpg","Lime aromalı ferahlatıcı içecek.","","1 Bardak","Lime","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Ice Tea","ice-tea.jpg","Şeftali veya limon aromalı soğuk çay.","","330 ml","Soğuk Çay","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Limonata","limonata.jpg","Taze limon ile hazırlanan ev yapımı limonata.","","1 Bardak","Limon","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Meyveli Soda","meyveli-soda.jpg","Meyve aromalı maden suyu.","","200 ml","Maden Suyu","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Red Bull","red-bull.jpg","Enerji içeceği.","","250 ml","Enerji İçeceği","Kafein içerir."),
P("Meşrubatlar","Sade Soda","sade-soda.jpg","Doğal maden suyu.","","200 ml","Maden Suyu","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Su","su.jpg","Doğal kaynak suyu.","","500 ml","Doğal Kaynak Suyu","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Sıkma Portakal","sikma-portakal.jpg","Taze sıkılmış portakal suyu.","","1 Bardak","Portakal","Bilinen temel alerjen yoktur."),
P("Meşrubatlar","Şalgam","salgam.jpg","Geleneksel şalgam suyu.","","300 ml","Şalgam","Bilinen temel alerjen yoktur."),
  
P("Smoothie & Frozen","Çilekli Frozen","cilekli-frozen.jpg","Taze çilek ile hazırlanan buzlu frozen.","","1 Bardak","Çilek, Buz","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Mangolu Frozen","mangolu-frozen.jpg","Taze mango ile hazırlanan frozen.","","1 Bardak","Mango, Buz","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Kivili Frozen","kivili-frozen.jpg","Taze kivi ile hazırlanan frozen.","","1 Bardak","Kivi, Buz","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Karadutlu Frozen","karadutlu-frozen.jpg","Karadut aromalı frozen.","","1 Bardak","Karadut, Buz","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Şeftalili Frozen","seftalili-frozen.jpg","Şeftali aromalı frozen.","","1 Bardak","Şeftali, Buz","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Meyve Kokteyli","meyve-kokteyli.jpg","Karışık meyvelerle hazırlanan içecek.","","1 Bardak","Karışık Meyveler","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Milkshake","milkshake.jpg","Soğuk ve kremamsı milkshake.","","1 Bardak","Süt","Süt içerir."),
P("Smoothie & Frozen","Çilekli Smoothie","cilekli-smoothie.jpg","Çilekli smoothie.","","1 Bardak","Çilek","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Mangolu Smoothie","mangolu-smoothie.jpg","Mangolu smoothie.","","1 Bardak","Mango","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Kivili Smoothie","kivili-smoothie.jpg","Kivili smoothie.","","1 Bardak","Kivi","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Karadutlu Smoothie","karadutlu-smoothie.jpg","Karadutlu smoothie.","","1 Bardak","Karadut","Bilinen temel alerjen yoktur."),
P("Smoothie & Frozen","Şeftalili Smoothie","seftalili-smoothie.jpg","Şeftalili smoothie.","","1 Bardak","Şeftali","Bilinen temel alerjen yoktur."), 

P("Soğuk Kahveler","Ice Americano","ice-americano.jpg","Buz ve espresso ile hazırlanan ferah Americano.","","1 Bardak","Espresso, Su, Buz","Bilinen temel alerjen yoktur."),
P("Soğuk Kahveler","Ice Caramel Macchiato","ice-caramel-macchiato.jpg","Karamel aromalı buzlu espresso.","","1 Bardak","Espresso, Süt, Karamel Şurubu, Buz","Süt içerir."),
...
P("Sıcak Kahveler","Caramel Macchiato","caramel-macchiato.jpg","Karamel aromalı espresso bazlı kahve.","","1 Fincan","Espresso, Süt, Karamel Şurubu","Süt içerir."),
P("Sıcak Kahveler","Chocolate Mocha Latte","chocolate-mocha-latte.jpg","Çikolata ve espresso ile hazırlanan latte.","","1 Fincan","Espresso, Süt, Çikolata","Süt içerir."),
P("Sıcak Kahveler","Espresso","espresso.jpg","Yoğun aromalı tek shot espresso.","","1 Fincan","Espresso","Bilinen temel alerjen yoktur."),
P("Sıcak Kahveler","Double Espresso","double-espresso.jpg","Çift shot espresso.","","1 Fincan","Espresso","Bilinen temel alerjen yoktur."),
P("Sıcak Kahveler","Hot Chocolate","hot-chocolate.jpg","Sıcak çikolata.","","1 Fincan","Süt, Çikolata","Süt içerir."),
P("Sıcak Kahveler","Aromalı Latte","aromali-latte.jpg","Vanilya, karamel veya fındık aromalı latte.","","1 Fincan","Espresso, Süt, Aroma Şurubu","Süt içerir."),
P("Sıcak Kahveler","Macchiato","macchiato.jpg","Süt köpüğü ile hazırlanan espresso.","","1 Fincan","Espresso, Süt","Süt içerir."),
P("Sıcak Kahveler","Türk Kahvesi","turk-kahvesi.jpg","Geleneksel Türk kahvesi.","","1 Fincan","Türk Kahvesi","Bilinen temel alerjen yoktur."),

P("Bitki Çayları","Adaçayı","adacayi.jpg","Geleneksel adaçayı, sıcak servis edilir.","","1 Fincan","Adaçayı","Bilinen temel alerjen yoktur."),
P("Bitki Çayları","Hibiskus","hibiskus.jpg","Hibiskus bitki çayı.","","1 Fincan","Hibiskus","Bilinen temel alerjen yoktur."),
P("Bitki Çayları","Ihlamur","ihlamur.jpg","Doğal ıhlamur çayı.","","1 Fincan","Ihlamur","Bilinen temel alerjen yoktur."),
P("Bitki Çayları","Kış Çayı","kis-cayi.jpg","Özel karışım kış çayı.","","1 Fincan","Bitki Karışımı","Bilinen temel alerjen yoktur."),
P("Bitki Çayları","Kuşburnu","kusburnu.jpg","Doğal kuşburnu çayı.","","1 Fincan","Kuşburnu","Bilinen temel alerjen yoktur."),
P("Bitki Çayları","Yeşil Çay","yesil-cay.jpg","Doğal yeşil çay.","","1 Fincan","Yeşil Çay","Bilinen temel alerjen yoktur."),

P("Sıcak İçecekler","Demleme Çay","demleme-cay.jpg","Geleneksel demleme siyah çay.","","1 Bardak","Siyah Çay","Bilinen temel alerjen yoktur."),
P("Sıcak İçecekler","Demleme Fincan Çay","demleme-fincan-cay.jpg","Demleme siyah çay fincanda servis edilir.","","1 Fincan","Siyah Çay","Bilinen temel alerjen yoktur."),
P("Sıcak İçecekler","Sade Nescafe","sade-nescafe.jpg","Sıcak suda hazırlanan klasik Nescafe.","","1 Fincan","Hazır Kahve","Bilinen temel alerjen yoktur."),
P("Sıcak İçecekler","Sütlü Nescafe","sutlu-nescafe.jpg","Süt ile hazırlanan yumuşak içimli Nescafe.","","1 Fincan","Hazır Kahve, Süt","Süt içerir."),
P("Sıcak İçecekler","Sahlep","sahlep.jpg","Tarçın ile servis edilen sıcak sahlep.","","1 Fincan","Sahlep, Süt","Süt içerir."),

P("Kokteyller","Long Island Ice Tea","long-island-ice-tea.jpg","Vodka, cin ve kola ile hazırlanan klasik kokteyl.","","Kadeh","Vodka, Bakardi, portakal likörü, Cin, Kola","Alkol içerir."),
P("Kokteyller","Sex on the Beach","sex-on-the-beach.jpg","Meyvemsi aromalı ferah kokteyl.","","Kadeh","Vodka, Şeftali Likörü, Portakal suyu, Granedin, Tekila ","Alkol içerir."),
P("Kokteyller","Mojito","mojito.jpg","Nane ve lime ile hazırlanan ferahlatıcı kokteyl.","","Kadeh","Bakardi, Esmer şeker, Nane, Lime, Soda","Alkol içerir."),
P("Kokteyller","Margarita","margarita.jpg","Tekila bazlı klasik margarita.","","Kadeh","Tekila, Portakal likörü, Şeker şurubu, Lime","Alkol içerir."),
P("Kokteyller","Apple Martini","apple-martini.jpg","Yeşil elma aromalı martini.","","Kadeh","Vodka, Martini, Soda, Elma Likörü","Alkol içerir."),
P("Kokteyller","Beyazıt","beyazit.jpg","Özel reçeteyle hazırlanan imza kokteyl.","","Kadeh","Votka, Cin, Tekila, Bakardi, Limon Suyu, Kavun Likörü, Soda","Alkol içerir."),
P("Kokteyller","Pina Colada","pina-colada.jpg","Ananas ve Hindistan cevizi aromalı tropikal kokteyl.","","Kadeh","Beyaz Rom, Ananas Suyu, Malibu, Süt, Krema","Alkol içerir."),
P("Kokteyller","Bacardi Fizz","bacardi-fizz.jpg","Bacardi rom ile hazırlanan ferah kokteyl.","","Kadeh","Bacardi Rom, Limon, Şeker Şurubu","Alkol içerir."),
P("Kokteyller","Peach Margarita","peach-margarita.jpg","Şeftali aromalı margarita.","","Kadeh","Tekila, Şeftali Likörü, Portakal Likörü, Şeftali, Lime","Alkol içerir."),

P("Kurudite","Havuç","havuc.jpg","Taze havuç dilimleri.","","Porsiyon","Havuç","Bilinen temel alerjen yoktur."),
P("Kurudite","Kurudite","kurudite.jpg","Taze havuç ve salatalık dilimlerinden oluşan kurudite tabağı.","","Porsiyon","Havuç, Salatalık","Bilinen temel alerjen yoktur."),
P("Kurudite","Soğüş","sogus.jpg","Taze salatalık dilimleri.","","Porsiyon","Salatalık","Bilinen temel alerjen yoktur."),
P("Kurudite","Turşu","tursu.jpg","Karışık turşu tabağı.","","Porsiyon","Karışık Turşu","Bilinen temel alerjen yoktur."),

P("İthal İçecekler","B-52","b-52.jpg","Klasik B-52 shot kokteyli.","","Shot","Kahve likörü, Irish cream, portakal likörü","Alkol içerir."),
P("İthal İçecekler","Baileys","baileys.jpg","Baileys Irish Cream.","","Kadeh","Irish Cream Likörü","Süt içerir, Alkol içerir."),
P("İthal İçecekler","Tek Cin","tek-cin.jpg","Tek ölçü cin.","","Tek","Cin","Alkol içerir."),
P("İthal İçecekler","Double Cin","double-cin.jpg","Duble ölçü cin.","","Duble","Cin","Alkol içerir."),
P("İthal İçecekler","Jager","jager.jpg","Jägermeister shot.","","Shot","Bitkisel likör","Alkol içerir."),
P("İthal İçecekler","Malibu","malibu.jpg","Hindistan cevizi aromalı rom likörü.","","Kadeh","Rom Likörü","Alkol içerir."),

P("Şaraplar","Blush Şişe","blush-sise.jpg","75 CL Blush şarap.","","75 CL","Şarap","Alkol içerir."),
P("Şaraplar","Blush Kadeh","blush-kadeh.jpg","Kadeh Blush şarap.","","Kadeh","Şarap","Alkol içerir."),
P("Şaraplar","Kadeh Şarap","kadeh-sarap.jpg","Kadeh servis edilir.","","Kadeh","Şarap","Alkol içerir."),
P("Şaraplar","Şişe Şarap 37.5 CL","sise-sarap-37-5-cl.jpg","37.5 CL şarap.","","37.5 CL","Şarap","Alkol içerir."),
P("Şaraplar","Şişe Şarap 75 CL","sise-sarap-75-cl.jpg","75 CL şarap.","","75 CL","Şarap","Alkol içerir."),

P("Tekilalar","Olmeca 35 CL","olmeca-35-cl.jpg","35 CL Olmeca Tekila.","","35 CL","Tekila","Alkol içerir."),
P("Tekilalar","Olmeca 50 CL","olmeca-50-cl.jpg","50 CL Olmeca Tekila.","","50 CL","Tekila","Alkol içerir."),
P("Tekilalar","Olmeca 70 CL","olmeca-70-cl.jpg","70 CL Olmeca Tekila.","","70 CL","Tekila","Alkol içerir."),
P("Tekilalar","Tekila Shot","tekila-shot.jpg","Tek shot tekila.","","Shot","Tekila","Alkol içerir."),

P("Viskiler","Tek Chivas","tek-chivas.jpg","Tek ölçü Chivas Regal.","","Tek","Viski","Alkol içerir."),
P("Viskiler","Double Chivas","double-chivas.jpg","Duble ölçü Chivas Regal.","","Duble","Viski","Alkol içerir."),
P("Viskiler","Tek Jack Daniel's","tek-jack-daniels.jpg","Tek ölçü Jack Daniel's.","","Tek","Viski","Alkol içerir."),
P("Viskiler","Double Jack Daniel's","double-jack-daniels.jpg","Duble ölçü Jack Daniel's.","","Duble","Viski","Alkol içerir."),
P("Viskiler","Chivas 35 CL","chivas-35-cl.jpg","35 CL Chivas Regal.","","35 CL","Viski","Alkol içerir."),
P("Viskiler","Chivas 50 CL","chivas-50-cl.jpg","50 CL Chivas Regal.","","50 CL","Viski","Alkol içerir."),
P("Viskiler","Chivas 70 CL","chivas-70-cl.jpg","70 CL Chivas Regal.","","70 CL","Viski","Alkol içerir."),
P("Viskiler","Chivas 100 CL","chivas-100-cl.jpg","100 CL Chivas Regal.","","100 CL","Viski","Alkol içerir."),
P("Viskiler","Jack Daniel's 35 CL","jack-daniels-35-cl.jpg","35 CL Jack Daniel's.","","35 CL","Viski","Alkol içerir."),
P("Viskiler","Jack Daniel's 70 CL","jack-daniels-70-cl.jpg","70 CL Jack Daniel's.","","70 CL","Viski","Alkol içerir."),

P("Votkalar","Tek Votka","tek-votka.jpg","Tek ölçü votka.","","Tek","Votka","Alkol içerir."),
P("Votkalar","Duble Votka","duble-votka.jpg","Duble ölçü votka.","","Duble","Votka","Alkol içerir."),
P("Votkalar","Tek Votka Enerji","tek-votka-enerji.jpg","Enerji içeceği ile servis edilir.","","Tek","Votka, Enerji İçeceği","Alkol içerir."),
P("Votkalar","Duble Votka Enerji","duble-votka-enerji.jpg","Enerji içeceği ile servis edilir.","","Duble","Votka, Enerji İçeceği","Alkol içerir."),
P("Votkalar","Absolut 35 CL","absolut-35-cl.jpg","35 CL Absolut Vodka.","","35 CL","Votka","Alkol içerir."),
P("Votkalar","Absolut 50 CL","absolut-50-cl.jpg","50 CL Absolut Vodka.","","50 CL","Votka","Alkol içerir."),
P("Votkalar","Absolut 70 CL","absolut-70-cl.jpg","70 CL Absolut Vodka.","","70 CL","Votka","Alkol içerir."),
P("Votkalar","Absolut 100 CL","absolut-100-cl.jpg","100 CL Absolut Vodka.","","100 CL","Votka","Alkol içerir."),

P("Biralar","3 Litre Biraver","3-litre-biraver.jpg","3 litre bira. Soğuk servis edilir.","","3 Litre","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Amsterdam 50 CL","amsterdam-50-cl.jpg","50 CL bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Belfast 50 CL","belfast-50-cl.jpg","50 CL bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Bavyera 1 LT","bavyera-1-lt.jpg","1 litre bira. Soğuk servis edilir.","","1 LT","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Becks 50 CL","becks-50-cl.jpg","50 CL bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Bomonti Filtresiz 50 CL","bomonti-filtresiz-50-cl.jpg","50 CL filtresiz bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Bud 50 CL","bud-50-cl.jpg","50 CL bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Corona 33 CL","corona-33-cl.jpg","33 CL bira. Soğuk servis edilir.","","33 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Efes Tombul 50 CL","efes-tombul-50-cl.jpg","50 CL bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Efes Fıçı 33 CL","efes-fici-33-cl.jpg","33 CL fıçı bira. Soğuk servis edilir.","","33 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Efes Fıçı 50 CL","efes-fici-50-cl.jpg","50 CL fıçı bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Efes Fıçı 70 CL","efes-fici-70-cl.jpg","70 CL fıçı bira. Soğuk servis edilir.","","70 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Efes Malt 50 CL","efes-malt-50-cl.jpg","50 CL malt içeceği. Soğuk servis edilir.","","50 CL","Malt","Gluten içerir."),
P("Biralar","Efes Özel Seri 50 CL","efes-ozel-seri-50-cl.jpg","50 CL özel seri bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Efes Şişe 50 CL","efes-sise-50-cl.jpg","50 CL şişe bira. Soğuk servis edilir.","","50 CL","Malt, şerbetçiotu, su","Gluten içerir."),
P("Biralar","Mexican Bardak","mexican-bardak.jpg","Mexican bira servis bardağı.","","","",""),
